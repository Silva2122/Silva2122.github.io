...
// на плотных экранах (3x — свежие айфоны) это уже 840, поэтому приводим всё
// к 900 и жмём в webp (числа подняты с прежних 600/1000 — см. admin/images.mjs).
//
...
// 1800 — берём как потолок, withoutEnlargement не даст растянуть то, что
// мельче (а оригиналы донора часто и не дотягивают до такого).
const GSIZE = Number(arg('--gallery-size', 1800));
